...
- Есть ручной Tune Monitor: расчет IF, 22 kHz, LNB 13/18V и проверка доступности Prof BDA tuner/TS capture.
...
2. Подключить `BdaTuneMonitor` к реальному tune request graph.
